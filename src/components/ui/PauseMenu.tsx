...
export const PauseMenu = () => {
  ...
  const [focusedButton, setFocusedButton] = useState<'resume' | 'settings' | 'menu'>('resume')
  ...
  }, [setGameState, focusedButton, showSettings])
      ...
      <PauseContainer>
        ...
        <ButtonGroup>
          ...
          <Button 
            ...
            onMouseEnter={() => setFocusedButton('settings')}
          >
            Settings
          </Button>
          <Button 
